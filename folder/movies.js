...
// this is an array of objects, arrays are the only thing in javascript with square brackets, objects have curly brackets
// and many properties
...
const movies = [
    ...
    movies.forEach(movie => {
        ...
        // Display a movie card for each movie object in Array, start with:

        // 1. Building HTML for card
        ...
        // 2. Putting that HTML on the webpage

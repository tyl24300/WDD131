...
const people = [{name: "James", age: 33}, {name: "Bob", age: 12}, {name: "Josh", age: 57}];
...
// event listener on button that takes in input
const searchButton = document.getElementById("searchButton");

searchButton.addEventListener("click", e => {
    
    // get what the user typed (user input string)
...
// make a function that will take user input string and compare it to objects in the array for a match
